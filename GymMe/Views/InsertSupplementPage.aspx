<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertSupplementPage.aspx.cs" Inherits="GymMe.Views.InsertSupplementPage" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="~/Styles/CSS/InsertSupplementPage.css" />
...
<body>
    <section class="container">
        ...
        <form class="form" runat="server">
            ...
            <div>
                <asp:Button class="button" ID="InsertSupplementBtn" runat="server" Text="Submit" OnClick="InsertSupplement_Click" />
            </div>
