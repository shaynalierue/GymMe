       ...
       SupplementController supplementController = new SupplementController();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SupplementNameTxt.Text = supplement.SupplementName;
                SupplementExpiryDateTxt.Text = supplement.SupplementExpiryDate.ToString("yyyy-MM-dd");
                SupplementPriceTxt.Text = supplement.SupplementPrice.ToString();
                SupplementTypeList.SelectedValue = supplement.SupplementTypeID.ToString();
            }
        ...
        protected void UpdateSupplement_Click(object sender, EventArgs e)
        { // Fetch input values from the form
            ...
            string result = supplementController.updateSupplement(id, supplementName, supplementExpiryDate, supplementPrice, supplementTypeID);
